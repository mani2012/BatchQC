                   ...
                   tabPanel("Differential Expression",
                            sidebarLayout(
                              sidebarPanel(
                                ...
                                checkboxInput("sortbybatch", "Sort By Batch First (Default: Sort By Condition First)", FALSE),
                              ...
                              sidebarPanel(
                                ...
                                selectInput("AggMethod", "Agglomeration Method:",
                                            c("Complete"="complete",
                                              ...
                                              "McQuitty" = "mcquitty",
                                              "Single" = "single")),
                                checkboxInput("colbybatchCD", "Color By Batch (Default: Color By Condition)", FALSE),
                      ...
                      sidebarLayout(
                        sidebarPanel(
                          ...
                          numericInput('ycol', 'Principal Component (y-axis)', 2,
                            min = 1, max = 50),
                          checkboxInput("colbybatchPCA", "Color By Batch (Default: Color By Condition)", FALSE),
