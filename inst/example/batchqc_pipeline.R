...
batchQC(signature_data, batch=batch, condition=condition, 
        report_file="batchqc_signature_data_report.html", report_dir=".", report_option_binary="111111111",
        view_report=FALSE, interactive=TRUE)
### apply combat
...
### Rerun the BatchQC pipeline on the batch adjusted data
batchQC(combat_data.matrix, batch=batch, condition=condition, 
        report_file="batchqc_combat_adj_signature_data_report.html", report_dir=".", report_option_binary="110011111",
        interactive=FALSE)
